<?php
ob_start();
define('API_KEY','280195956:AAEqzL5wGSgUaMUO3nshuMHLVdgXFeXEXI8');
$admin = "278971311";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'Ali_SudO','url'=>'https://telegram.me/Ali_SuDo']
        ],
        [
          ['text'=>'Erfan_SudO','url'=>'https://telegram.me/Erfan_sudo']
        ]
      ]
    ])
  ]);
